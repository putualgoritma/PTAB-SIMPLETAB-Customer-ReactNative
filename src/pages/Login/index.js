...
const Login = props => {
  ...
  const notif = async () => {
    ...
    try {
      ...
      console.log('ini onesignal', device.userId);
          ...
          .then(result => {
            ...
            if (result.pass_set == 0) {
              navigation.navigate('Register', {
                ...
                _id_onesignal: device.userId,
                name: result.data.name,
                address: result.data.address,
              });
            } else {
              alert(
                'Data Pelanggan sudah teregistrasi, tolong masukkan nomor SBG dan Password.',
              );
            }
          })
          .catch(e => {
  ...
  const handleData = data => {
    ...
    if (data.code != null && data.password != null && data.OTP != null) {
      ...
      <ScrollView>
        ...
        <View style={styles.baseBoxShadow}>
          <View style={styles.boxShadow}>
            ...
            <View style={{width: '100%', alignItems: 'center'}}>
              <CopilotStep text="Masukan Password." order={2} name="DuaUnique">
                <CustomCopilot marginTop={38} />
              </CopilotStep>
            ...
            <View style={{width: '80%'}}>
              <Text style={{fontSize: 12, color: 'red'}}>
                Lupa Password Silahkan Hubungi Kantor Pusat PERUMDA Tirta
                Amertha Bhuana.
              </Text>
              {/* <CopilotStep
            ...
            <View style={{width: '80%', alignItems: 'center'}}>
              ...
              <Text style={{fontSize: 12, color: 'red'}}>
                Pelanggan Yang Belum Memiliki Account Password Silahkan Scan QR
                Meteran Anda.
              </Text>
              <Distance distanceV={5} />
              <TouchableOpacity onPress={() => navigation.navigate('Scan')}>
